  ...
  return (
    <>
      <header className="sticky top-0 w-full bg-white">
        <Gutter size="large" className="flex">
          <Link to="/" prefetch="intent">
            {(site.logo as Media) && (
              <Image className={classes.logo} image={site.logo as Media} width={200} height={50} />
            )}
          ...
          <button onClick={toggleMenu} className={classes.menuButton} aria-label="Menu">
