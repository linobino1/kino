...
import type { FilmPrint, Movie, Event, Site } from "payload/generated-types";
import type {
  ItemList,
  ScreeningEvent,
  Event as SchemaOrgEvent,
} from "schema-dts";
...
export const eventSchema = (
  ...
  if (event.type === "screening") {
    ...
    res = {
      ...
      endDate: new Date(
        parseISO(event.date).getTime() + movie.duration * 60 * 1000
      ).toISOString(),
    };
  }
