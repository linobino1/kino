...
import type { FilmPrint, Movie, Screening, Site } from "payload/generated-types";
import type {
  ItemList,
  ScreeningEvent,
} from "schema-dts";
...
export const screeningSchema = (screening: Screening, site: Site): ScreeningEvent => {
...
export const screeningsListSchema = (screenings: Screening[], site: Site): ItemList => {
